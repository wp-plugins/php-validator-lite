...
By default, *PHP Validator* looks for methods and functions, and lists them in red if not found. But if you would like it to list all tokens like functions and includes, please check this option.
